...
l10nstrings.strServerAudit = _('Server audit');
l10nstrings.strServerAuditStatus = _('Status');
l10nstrings.strServerAuditDetails = _('Details');
l10nstrings.strServerAuditNoIssues = _('No issues found');
...
l10nstrings.strFlamegraph = _('Flamegraph');
...
l10nstrings.strProfileThread = _('Thread');
l10nstrings.strProfileAllThreads = _('All threads');
...
l10nstrings.strProfileResetZoom = _('Whole graph');
