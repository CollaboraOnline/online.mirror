...
const char* ODF_MANIFEST_NS = "urn:oasis:names:tc:opendocument:xmlns:manifest:1.0";
const char* ODF_OFFICE_NS = "urn:oasis:names:tc:opendocument:xmlns:office:1.0";
const char* ODF_META_NS = "urn:oasis:names:tc:opendocument:xmlns:meta:1.0";
const char* ODF_TEXT_NS = "urn:oasis:names:tc:opendocument:xmlns:text:1.0";
const char* ODF_DRAW_NS = "urn:oasis:names:tc:opendocument:xmlns:drawing:1.0";
const char* ODF_FORM_NS = "urn:oasis:names:tc:opendocument:xmlns:form:1.0";
const char* ODF_PRESENTATION_NS = "urn:oasis:names:tc:opendocument:xmlns:presentation:1.0";
const char* ODF_SMIL_NS = "urn:oasis:names:tc:opendocument:xmlns:smil-compatible:1.0";
...
// What one sniffed XML entry looks like: its root element plus whatever
// the ID and generator harvesting found along the way.
struct SniffResult
{
    std::string rootNs;
    ...
    void reportFindings()
    {
        if (duplicateCount > ErrorCapper::threshold)
        {
            commentary.addComment("WARN",
                                  "<i>" + std::to_string(duplicateCount - ErrorCapper::threshold)
        ...
        {
            commentary.addComment("WARN",
                                  "<i>" + std::to_string(absentCount - ErrorCapper::threshold)
...
void validateOdfDoc(const XmlNode* document, const std::string& entryName,
                    const std::string& version, ValidationReport& commentary,
                    SchemaCache& schemas)
{
                      ...
                      ValidationReport& commentary, SchemaCache& schemas)
{
    ...
    if (!schema)
    {
        commentary.addComment("FATAL",
                              schemaError.empty() ? "No manifest schema is available"
                                                  : schemaError);
        commentary.decIndent();
        return;
    }
