...
{
    return std::string(COFFICEOTRON_DATA_DIR) + relative;
}
...
public:
    ...
    void testProcessContentWildcard()
    {
        ...
        std::string actual = filterMCE("<aaa xmlns:ext=\"some-ext\" xmlns:ext2=\"some-ext2\" "
                                           ...
                                           "</aaa>",
                                       errors);
        CPPUNIT_ASSERT_EQUAL("<aaa xmlns:ext=\"some-ext\" xmlns:ext2=\"some-ext2\" xmlns:mc=\""
                                 + MC + "\"><eee/></aaa>",
                             actual);
        CPPUNIT_ASSERT_EQUAL(0, errors);
    }
    ...
    {
        CPPUNIT_ASSERT_EQUAL(std::string("s1 s2 s3"),
                             MCENormalizeWhitespaces(" s1 \ts2  \rs3\n"));
    }
