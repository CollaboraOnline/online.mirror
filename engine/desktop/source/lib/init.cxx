...
static std::string getSentenceCheckingPackages()
{
    ...
    try
    {
        css::uno::Reference<linguistic2::XSupportedLocales> xChecker(
            comphelper::getProcessServiceFactory()->createInstance(
                u"com.collaboraoffice.lingu.Lightproof"_ustr),
            uno::UNO_QUERY);
        if (xChecker.is())
    ...
    {
        TOOLS_WARN_EXCEPTION("lok", "cannot ask the sentence checker for its locales");
    }
