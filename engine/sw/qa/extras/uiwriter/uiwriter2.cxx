...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest2, testTdf136704)
{
    ...
    pTextDoc->postKeyEvent(COKitKeyEventType::UP, 0, KEY_RETURN);
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest2, testTdf108687_tabstop)
{
    ...
    SwXTextDocument* pTextDoc = getSwTextDoc();
    pTextDoc->postKeyEvent(COKitKeyEventType::DOWN, 0, KEY_TAB);
    pTextDoc->postKeyEvent(COKitKeyEventType::UP, 0, KEY_TAB);
    Scheduler::ProcessEventsToIdle();
